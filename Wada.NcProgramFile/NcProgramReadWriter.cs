...
{
    [Logging]
    public async Task<NcProgramCode> ReadAllAsync(StreamReader reader, ReadNcProgramType readNcProgram, string programName)
    {
    ...
    public Task<NcProgramCode> ReadSubProgramAll(StreamReader reader, string programName)
        => ReadAllAsync(reader, ReadNcProgramType.SubProgram, programName);
}
